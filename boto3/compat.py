...
def _warn_deprecated_python():
    ...
    if py_version in deprecated_versions:
        ...
        warning = f"Boto3 will no longer support Python {py_version[0]}.{py_version[1]} starting {params['date']}. To continue receiving service updates, bug fixes, and security updates please upgrade to Python 3.7 or later. More information can be found here: {params['blog_link']}"
